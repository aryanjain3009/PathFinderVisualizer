const BUCKET_CAPACITY = 100; // Max requests the bucket can hold
...
// Simulation: Add random requests
let counter = 1;
setInterval(() => {
    handleIncomingRequest(counter++);
}, 300); // Add a request every 300ms (faster than leak rate)